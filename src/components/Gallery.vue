<template>
  <div class="container gallery py-5">
    <h2 class="text-center mb-4">Our Amazing Work</h2>
    <div class="row">
...
const images = ref([
  {
    ...
    description: 'Sparkling clean kitchen after our professional cleaning service.'
  },
  {
    id: 2,
    src: '../assets/image1.jpg',
    ...
    description: 'A fresh and organized living room after our meticulous cleaning.'
  },
  {
    id: 3,
    src: '../assets/image1.jpg',
  ...
  },
  {
    ...
    description: 'A spotless bathroom after our deep cleaning service.'
  },
  {
    id: 5,
    src: '../assets/image1.jpg',
